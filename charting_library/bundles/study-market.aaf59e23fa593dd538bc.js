  ...
  [6456], {
    ...
    80511: (e, t, n) => {
      ...
      function c(e) {
        ...
        return r(h, l().button, l()["size-" + n], l()["color-" + t], l()["variant-" + i], a && l().stretch, (s || c) && l()["with-start-icon"], d && l()["with-end-icon"], u && l()["icon-only"], v, m && l().grouped, m && !g && l()["adjust-position"], m && p.isTop && l()["first-row"], m && p.isLeft && l()["first-col"])
      }
      ...
      function d(e) {
        ...
        return i.createElement(i.Fragment, null, d && "xsmall" !== t && i.createElement(a.Icon, {
          icon: d,
          className: l()["start-icon-wrap"]
        }), s && i.createElement("span", {
          className: l().content
        }, s), c && !o && "xsmall" !== t && i.createElement(a.Icon, {
          icon: c,
      ...
      function p(e) {
        ...
        } = (0, i.useContext)(u.ControlGroupContext), s = c({
          ...n,
          isGrouped: r,
          cellState: o,
          disablePositionAdjustment: a
    ...
    45745: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          isMobile: a,
          isTablet: s
        } = c(t), d = o()(l.container, s && l.isTablet, a && l.isMobile, n);
        return i.createElement("div", {
          ...r,
          className: d,
    ...
    36108: (e, t, n) => {
      ...
      function m(e) {
        ...
        const {
          ...
          version: d,
          extra: u
        } = e, h = c.enabled("graying_disabled_tools_enabled") && (null === (t = window.ChartApiInstance) || void 0 === t ? void 0 : t.studiesAccessController.isToolGrayed(i)), m = (null == u ? void 0 : u.isChartPattern) || n.includes("CP@tv-basicstudies") ? "chart-patterns" : l().getPackageName(n);
        return {
          id: n,
          title: a || (0, o.t)(i, {
            context: "study"
      ...
      function L(e) {
        const t = (0, i.useContext)(R),
          ...
          L = (null == t ? void 0 : t.toggleFavorite) ? P(t.toggleFavorite, a) : void 0,
          O = (0, S.useWatchedValueReadonly)({
            watchedValue: N.watchedTheme
          }) === I.StdTheme.Dark ? T.dark : T.light,
          B = g()(T.container, a.isGrayed && T.disabled, h && T.selected, m && T.highlighted, m && O);
        return i.createElement("div", {
          ref: p,
          className: B,
          onClick: w,
        ...
        }, _ && i.createElement(F.FavoriteButton, {
          ...
          type: "updated",
          className: T.badge
        }), x && i.createElement(BadgeIndicator, {
          type: "ep",
          className: T.badge,
          ...
          target: "_blank",
          onClick: D
        }, y.authorName), "mobile" !== r && y && i.createElement("span", {
          className: T.likes
        }, y.likesCount), !1)
      }
      ...
      function B(e) {
        ...
        return i.createElement("h3", {
          className: g()(O.title, "Small" === n && O.small, "Normal" === n && O.normal, "Large" === n && O.large, r)
        }, t)
      }
      var z = n(89182);
      ...
      function Z(e) {
        ...
        }, o), a && s && i.createElement(A.Button, {
          onClick: s,
          className: q.button
        }, a))
      }
      ...
      function G(e) {
        const {
          ...
          onClose: a,
          applyStudy: s
        } = e, [l, c] = (0, i.useState)(""), d = (0, i.useMemo)(() => (0, W.createRegExpList)(l, h), [l]), u = (0, i.useMemo)(() => l ? (0, W.rankedSearch)({
          data: n,
          rules: d,
          queryString: l,
          ...
          let o = 0;
          const [a, s] = (0, i.useState)(null), l = (0, i.useRef)(null), c = (0, i.useRef)(null), [d, u, h, m] = H(t), p = (0, i.useRef)(null);
          return (0, i.useEffect)(() => {
            e ? g(0) : u(null)
          }, [e]), (0, i.useEffect)(() => {
            void 0 !== r && (g(0), u(null))
          }, [r]), (0, i.useEffect)(() => (a && (o = setTimeout(() => {
            s(null)
          }, 1500)), () => {
            clearInterval(o)
          }), [a]), {
            ...
            handleKeyDown: function (e) {
              ...
              40 === (0, D.hashFromEvent)(e) && (e.preventDefault(), h(), g(i));
              38 === (0, D.hashFromEvent)(e) && (e.preventDefault(), m(), g(t));
        ...
        return (0, i.useEffect)(() => {
          var e;
          r || c(""), b.CheckMobile.any() || null === (e = C.current) || void 0 === e || e.focus()
          ...
          render: function () {
            return i.createElement(i.Fragment, null, i.createElement(E.DialogSearch, {
              reference: C,
              placeholder: (0, o.t)("Search"),
              onChange: N,
              onFocus: I
            }), i.createElement(y.DialogSidebarWrapper, null, i.createElement(_, {
              reference: w,
              className: V.scroll
            }, S ? i.createElement(v.Spinner, null) : u.length ? i.createElement(i.Fragment, null, i.createElement(M, null, i.createElement(B, {
        ...
        function I() {
          var e;
          l.length > 0 && (null === (e = C.current) || void 0 === e || e.select())
        }
      }
      var j = n(18437),
        J = n(32856),
      ...
      class U extends class {
        constructor(e) {
          this._searchInputRef = i.createRef(), this._dialog = i.createRef(), this._visibility = new(K())(!1), this._container = document.createElement("div"), this._isForceRender = !1, this._parentSource = null, this._isDestroyed = !1, this._symbolInfo = null, this._deepFundamentalsHistoryNotificationHasBeenShown = !1, this._showDeepFundamentalsHistoryNotification = () => {}, this._chartWidgetCollection = e
        }
        isDestroyed() {
        ...
        open(e) {
          this._parentSource = null != e ? e : null, this._updateSymbolInfo(), this._setProps({
            isOpened: !0
          }), this._visibility.setValue(!0), j.emit("indicators_dialog")
        }
        show() {
          this.open()
        }
        ...
        _applyStudy(e, t) {
          var n, i;
          e.isGrayed ? j.emit("onGrayedObjectClicked", {
            type: "study",
            name: e.shortDescription
          }) : (b.CheckMobile.any() || null === (n = this._searchInputRef.current) || void 0 === n || n.select(), async function (e, t, n, i, r) {
            ...
            var e;
            b.CheckMobile.any() || (null === document.activeElement || document.activeElement === document.body || null !== this._dialog.current && this._dialog.current.contains(document.activeElement)) && (null === (e = this._searchInputRef.current) || void 0 === e || e.focus())
          }))
        }
        _setProps(e) {
        ...
        constructor(e, t) {
          super(e), this._studies = {}, this._options = {
            onWidget: !1
          }, this._getStudies = e => this._studies[e] || [], t && (this._options = t), this._props = new(K())({
            data: [],
    ...
    65802: (e, t, n) => {
      ...
      function o(e, t) {
        const n = [],
          i = e.toLowerCase(),
          r = e.split("").map((e, t) => `(${0!==t?"[/\\s-]"+s(e):s(e)})`).join("(.*?)") + "(.*)";
        return n.push({
    ...
    11945: (e, t, n) => {
      ...
      function s(e) {
        const {
          ...
          text: s,
          className: l
        } = e, c = (0, i.useMemo)(() => (0, o.getHighlightedChars)(t, s, n), [t, n, s]);
        return i.createElement(i.Fragment, null, c.length ? s.split("").map((e, t) => i.createElement(i.Fragment, {
          key: t
        }, c[t] ? i.createElement("span", {
          className: r(a.highlighted, l)
        }, e) : i.createElement("span", null, e))) : s)
      }
    },
    27278: (e, t, n) => {
      "use strict";
